...
public class ProductValidation {
	...
	private static final String PRODUCT_NAME_LENGTH = "Product name length should not be more than" + PRODUCT_MAX_CHARS
			+ " characters";
	private static final String EMPTY_PRODUCT_SKU = "Please provide the SKU";
	private static final String PRODUCT_SKU_LENGTH = "Product SKU length should not be more than" + PRODUCT_MAX_CHARS
			+ " characters";
	...
	public String isValidProduct(Product product) {
		...
		if (product.getName() != null && productNameLength >= PRODUCT_MIN_CHARS
				&& productNameLength > PRODUCT_MAX_CHARS)
